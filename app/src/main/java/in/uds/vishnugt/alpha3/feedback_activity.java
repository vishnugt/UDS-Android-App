    ...
    private class LongOperationsubmit extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                oswrite=oswrite.concat("{\"type\":\"feedback\",");
                oswrite=oswrite.concat("\"query\":\"Toilet cleanliness\",\"reply\":\""+input.get(2).toString()+"\"},");
                oswrite=oswrite.concat("{\"type\":\"feedback\",");
                oswrite=oswrite.concat("\"query\":\"Floor cleanliness\",\"reply\":\""+input.get(3).toString()+"\"},");
                oswrite=oswrite.concat("{\"type\":\"feedback\",");
                oswrite=oswrite.concat("\"query\":\"Pantry cleanliness\",\"reply\":\""+input.get(4).toString()+"\"},");
                oswrite=oswrite.concat("{\"type\":\"feedback\",");
                oswrite=oswrite.concat("\"query\":\"Dusting\",\"reply\":\""+input.get(5).toString()+"\"},");
                oswrite=oswrite.concat("{\"type\":\"feedback\",");
